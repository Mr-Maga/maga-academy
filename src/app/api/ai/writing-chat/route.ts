...
import { geminiConfigured, writingChat } from "@/lib/gemini";
...
export async function POST(request: Request) {
  ...
  if (!geminiConfigured()) {
    return NextResponse.json({ reply: "AI hozircha sozlanmagan." });
  }

  let body: { question?: string; essay?: string; evalSummary?: string; messages?: InMsg[] };
  try {
